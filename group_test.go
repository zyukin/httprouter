...
func TestRouteGroupOfARouteGroup(t *testing.T) {
	...
	bar.GET("/GET", func(w http.ResponseWriter, r *http.Request) {
		get = true
	})
...
func TestRouteGroupAPI(t *testing.T) {
	...
	group.GET("/GET", func(w http.ResponseWriter, r *http.Request) {
		get = true
	})
	group.HEAD("/GET", func(w http.ResponseWriter, r *http.Request) {
		head = true
	})
	group.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request) {
		options = true
	})
	group.POST("/POST", func(w http.ResponseWriter, r *http.Request) {
		post = true
	})
	group.PUT("/PUT", func(w http.ResponseWriter, r *http.Request) {
		put = true
	})
	group.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request) {
		patch = true
	})
	group.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request) {
		delete = true
	})
